...
st.markdown("*Manage your distributed system nodes efficiently. You can register new nodes, view all nodes, and search for specific nodes.*")
...
st.markdown("Add a new node to the registry.")
...
st.markdown("View and manage all registered nodes.")

nodes = get_all_nodes()

if not nodes:
    st.info("📭 No nodes registered yet. Use the form above to register one.")
else:
...
st.markdown("Search for a specific node by name.")
